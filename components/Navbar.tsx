...
function Navbar({ toggleMode, darkMode }: NavBarProps) {
  ...
  return (
    <nav className="bg-navbar-light dark:bg-navbar-dark flex justify-between items-center w-[95%] sm:w-4/5 xl:w-3/5 py-2 px-8 border border-navbar-light-b dark:border-border-grey mx-auto mt-8 rounded-full shadow-xl">
